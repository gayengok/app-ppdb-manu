        ...
        <div class="page-inner py-4">
            ...
            <div class="card shadow-lg border-0 rounded-lg mb-4">
                <div class="card-body p-0">
                    <div class="bg-gradient-primary text-white p-4 rounded-top">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-white text-primary fw-bold px-3 py-2 rounded-pill">
                                Total: <?php echo e($dokumens->total()); ?>
                    ...
                    <div class="p-4">
                        <form method="GET" action="<?php echo e(route('admin.dokumen.index')); ?>">
                            <div class="input-group mb-0">
                                <span class="input-group-text bg-white border-end-0">
                                    <i class="fas fa-search text-primary"></i>
                                </span>
                                <input type="text" name="search" class="form-control border-start-0 ps-0"
                                    placeholder="Cari berdasarkan nama siswa..." value="<?php echo e(request('search')); ?>">
                ...
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $dokumens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-top">
                                        <td class="ps-4">
                                            <?php echo e(($dokumens->currentPage() - 1) * $dokumens->perPage() + $loop->iteration); ?>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div
                                                    ...
                                                    <span
                                                        class="text-white fw-bold"><?php echo e(substr($dokumen->nama, 0, 1)); ?></span>
                                                </div>
                                                <div>
                                                    <h6 class="mb-0 fw-bold"><?php echo e($dokumen->nama); ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <?php if($dokumens->count() == 0): ?>
                        <div class="text-center py-5">
                            <img src="<?php echo e(asset('assets/images/empty-state.svg')); ?>" alt="No Data" class="img-fluid mb-3"
                                style="max-width: 200px;">
                            <h5 class="text-muted">Tidak ada data dokumen ditemukan</h5>
                            <?php if(request('search')): ?>
                                <p>Tidak ada hasil untuk pencarian "<?php echo e(request('search')); ?>"</p>
                                <a href="<?php echo e(route('admin.dokumen.index')); ?>" class="btn btn-outline-primary mt-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center border-top p-4">
                        <div class="text-muted">
                            <?php if($dokumens->total() > 0): ?>
                                Menampilkan <?php echo e($dokumens->firstItem()); ?> hingga <?php echo e($dokumens->lastItem()); ?> dari
                                <?php echo e($dokumens->total()); ?> data
                            <?php else: ?>
                                Tidak ada data yang tersedia
                            <?php endif; ?>
                        </div>
                        <div>
                            <?php echo e($dokumens->links('pagination::bootstrap-5')); ?>
