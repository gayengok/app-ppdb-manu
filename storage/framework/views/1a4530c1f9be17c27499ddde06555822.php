...
<body>
    <div class="register-container">
        ...
        <div class="right-side">
            ...
            <form id="registerForm" method="POST" action="<?php echo e(route('calon_siswa.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <p class="login-link">Sudah memiliki akun? <a href="<?php echo e(route('login_siswa')); ?>">Masuk</a></p>
            </form>
        </div>
    </div>
