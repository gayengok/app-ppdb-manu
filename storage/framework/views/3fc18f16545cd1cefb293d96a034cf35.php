                ...
                <div class="col-md-12">
                    <div class="card shadow-lg border-0 rounded-lg">
                        ...
                        <div class="quiz-container p-4">
                            <form action="<?php echo e(route('quiz.submit')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="tab-pane fade show active" id="indo" role="tabpanel"
                                        ...
                                        <div class="question-card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php $__currentLoopData = $indoQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="question-item mb-4">
                                                        <div class="question-number"><?php echo e($count); ?></div>
                                                        <div class="question-content">
                                                            <h5 class="question-text"><?php echo e($question->question_text); ?></h5>
                                                                ...
                                                                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="option-item">
                                                                        <input class="option-input" type="radio"
                                                                            name="<?php echo e($question->question_id); ?>"
                                                                            id="<?php echo e($question->question_id); ?>_<?php echo e($option['value']); ?>"
                                                                            value="<?php echo e($option['value']); ?>" required>
                                                                        <label class="option-label"
                                                                            for="<?php echo e($question->question_id); ?>_<?php echo e($option['value']); ?>">
                                                                            <span
                                                                                class="option-marker"><?php echo e($option['value']); ?></span>
                                                                            <span
                                                                                class="option-text"><?php echo e($option['text']); ?></span>
                                                                        </label>
                                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="mtk" role="tabpanel" aria-labelledby="mtk-tab">
                                        <div class="question-card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php $__currentLoopData = $mtkQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="question-item mb-4">
                                                        <div class="question-number"><?php echo e($count); ?></div>
                                                        <div class="question-content">
                                                            <h5 class="question-text"><?php echo e($question->question_text); ?></h5>
                                    ...
                                    <div class="tab-pane fade" id="eng" role="tabpanel" aria-labelledby="eng-tab">
                                        <div class="question-card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php $__currentLoopData = $engQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="question-item mb-4">
                                                        <div class="question-number"><?php echo e($count); ?></div>
                                                        <div class="question-content">
                                                            <h5 class="question-text"><?php echo e($question->question_text); ?></h5>
...
<?php echo $__env->make('backend.admin.app.app_siswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/admin/pendaftaran/test_ppdb/test-soal.blade.php ENDPATH**/ ?>