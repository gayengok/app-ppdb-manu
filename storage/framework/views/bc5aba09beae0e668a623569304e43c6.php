    ...
    <div class="gallery-container">
        <div class="gallery-header">
            ...
            <div class="gallery-actions">
                <a href="<?php echo e(route('photo.create')); ?>" class="btn-upload">
            ...
            <div class="view view-grid active">
                    ...
                    <div class="gallery-card">
                        <div class="gallery-card-image">
                            ...
                            <div class="image-overlay">
                                <a href="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" class="overlay-btn preview-btn">
                                    <i class="fas fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                        <div class="gallery-card-content">
                            <h4 class="gallery-card-title"><?php echo e($photo->title); ?></h4>
                            <div class="gallery-card-actions">
                                <a href="<?php echo e(route('photo.edit', $photo->id)); ?>" class="card-btn edit-btn">
                        ...
                        <div class="gallery-card-number"><?php echo e($loop->iteration); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-gallery">
                        ...
                        <a href="<?php echo e(route('photo.create')); ?>" class="empty-btn">
            ...
            <div class="view view-list">
                <table class="premium-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><span class="table-number"><?php echo e($loop->iteration); ?></span></td>
                                <td>
                                    <div class="table-title"><?php echo e($photo->title); ?></div>
                                </td>
                                <td>
                                    <div class="table-image">
                                        <img src="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" alt="<?php echo e($photo->title); ?>">
                                        <div class="image-overlay">
                                            <a href="<?php echo e(asset('storage/' . $photo->photo_path)); ?>"
                                ...
                                <td>
                                    <div class="table-actions">
                                        <a href="<?php echo e(route('photo.edit', $photo->id)); ?>" class="table-btn edit-btn">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="<?php echo e(route('photo.destroy', $photo->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
