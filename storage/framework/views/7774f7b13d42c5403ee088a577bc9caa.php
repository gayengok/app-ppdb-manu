                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0"
                                ...
                                <tbody class="border-top-0">
                                    <?php $__currentLoopData = $calon_siswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-bottom">
                                            <td class="py-3 px-4 fw-medium text-muted"><?php echo e($loop->iteration); ?></td>
                                            <td class="py-3 px-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 fw-semibold"><?php echo e($siswa->name); ?></h6>
                                                        <i class="fas fa-check-circle text-success ms-2"></i>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-3 px-4"><?php echo e($siswa->nisn); ?></td>
                                            <td class="py-3 px-4">
                                                <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-4 border-top"
                            ...
                            <div class="text-muted small">
                                Menampilkan <span class="fw-semibold"><?php echo e($calon_siswas->firstItem()); ?></span> hingga
                                <span class="fw-semibold"><?php echo e($calon_siswas->lastItem()); ?></span> dari
                                <span class="fw-semibold"><?php echo e($calon_siswas->total()); ?></span> siswa
                            </div>
                            <div>
                                <?php echo e($calon_siswas->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('backend.dashboard.dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/pengaturan/data_akun/akun_siswa.blade.php ENDPATH**/ ?>