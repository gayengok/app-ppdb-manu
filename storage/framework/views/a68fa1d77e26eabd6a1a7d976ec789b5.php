        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link <?php echo e(request()->routeIs('news.blog') ? 'active' : ''); ?>"
                        href="<?php echo e(route('news.blog')); ?>">Berita</a></li>

                <li>
                    <a class="nav-link <?php echo e(request()->routeIs('ppdb.siswa') ? 'active' : ''); ?>"
                        href="<?php echo e(route('ppdb.siswa')); ?>">
                        PPDB
                    </a>
                </li>

                <li class="dropdown">
                    <a class="<?php echo e(request()->routeIs('galery.foto', 'galery.video') ? 'active' : ''); ?>" href="#">
                        <span>Gallery</span> <i class="bi bi-chevron-down"></i>
                    </a>
                    <ul>
                        <li>
                            <a class="<?php echo e(request()->routeIs('galery.foto') ? 'active' : ''); ?>"
                                href="<?php echo e(route('galery.foto')); ?>">
                                Photo
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(request()->routeIs('galery.video') ? 'active' : ''); ?>"
                ...
                <li class="dropdown">
                    <a class="<?php echo e(request()->routeIs('profil.sejarah') || request()->routeIs('profil.visi-misi') ? 'active' : ''); ?>"
                        href="#">
                        <span>Profil</span> <i class="bi bi-chevron-down"></i>
                    </a>
                    <ul>
                        <li>
                            <a class="<?php echo e(request()->routeIs('profil.sejarah') ? 'active' : ''); ?>"
                                href="<?php echo e(route('profil.sejarah')); ?>">
                                Sejarah
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(request()->routeIs('profil.visi-misi') ? 'active' : ''); ?>"
