                            ...
                            <table class="table table-hover premium-table">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $informasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="schedule-item">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php echo e($informasi->tanggal_formatted); ?>

                                                </div>
                                            </td>

                                            <td class="text-muted"><?php echo e($informasi->deskripsi); ?></td>
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-soft-primary rounded-pill me-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editModal-<?php echo e($informasi->id); ?>">
                                                        <i class="fas fa-edit me-1"></i> Edit
                                                    </button>
                                                    <button class="btn btn-soft-danger rounded-pill" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal-<?php echo e($informasi->id); ?>">
                                        ...
                                        <div class="modal fade" id="editModal-<?php echo e($informasi->id); ?>" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content rounded-4 border-0 shadow-lg">
                                                    ...
                                                    <div class="modal-body p-5">
                                                        <form action="<?php echo e(route('admin.informasi.update', $informasi->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="row g-4">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="tahap" value="<?php echo e($informasi->tahap); ?>"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-elegant"
                                                                        name="tanggal"
                                                                        value="<?php echo e($informasi->tanggal_formatted); ?>"
                                                                        required>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label fw-bold">Deskripsi</label>
                                                                    <textarea class="form-control form-control-elegant" name="deskripsi" rows="4" required><?php echo e($informasi->deskripsi); ?></textarea>
                                                                </div>
                                        ...
                                        <div class="modal fade" id="deleteModal-<?php echo e($informasi->id); ?>" tabindex="-1">
                                                ...
                                                <div class="modal-content rounded-4 border-0 shadow-lg">
                                                    ...
                                                    <div class="modal-body text-center p-5">
                                                        <p class="fs-5 mb-4">
                                                            ...
                                                            <strong><?php echo e($informasi->tahap); ?></strong>?
                                                        </p>
                                                        <form
                                                            action="<?php echo e(route('admin.informasi.destroy', $informasi->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.dashboard.dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/informasi/ppdb/upload_inf_ppdb.blade.php ENDPATH**/ ?>