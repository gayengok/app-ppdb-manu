    ...
    <section class="news-article-section py-8 bg-light">
        <div class="container">
            ...
            <div class="bg-white p-4 rounded-3 shadow-sm">
                <form action="<?php echo e(route('upload.syarat')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.home.landingpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/frontend/students/syarat-pendaftaran.blade.php ENDPATH**/ ?>