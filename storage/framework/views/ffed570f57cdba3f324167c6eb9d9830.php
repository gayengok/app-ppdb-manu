...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('auth/img/Logo-MA.png')); ?>" type="image/x-icon" />
        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="POST" action="<?php echo e(route('login_siswa.login')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a
                                    href="<?php echo e(route('register_siswa.index')); ?>" class="link-danger">Register</a></p>
                        </div>
                    </form>
                </div>
            </div>
