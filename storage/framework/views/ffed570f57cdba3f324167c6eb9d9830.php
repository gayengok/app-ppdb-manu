...
<body>
    <div class="register-container">
        ...
        <div class="right-side">
            ...
            <form id="loginForm" method="POST" action="<?php echo e(route('login_siswa.login')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <p class="login-link"><a href="<?php echo e(route('register_siswa.index')); ?>">Daftar
                        Sekarang</a></p>
...
<?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/admin/login-siswa/login_siswa.blade.php ENDPATH**/ ?>