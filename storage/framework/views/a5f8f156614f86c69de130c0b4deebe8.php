                    ...
                    <div class="list-group mt-4">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('soal-verbal.index')); ?>" class="btn btn-success ms-3">MULAI</a>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.home.landingpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/frontend/test-soal/pilihan-soal/index.blade.php ENDPATH**/ ?>