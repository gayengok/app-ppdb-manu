...
<body>
    ...
    <div class="nomor">
        Nomor: <?php echo e(date('Y')); ?>/PPDB-MA/<?php echo e(date('m')); ?>/<?php echo e($attempt->id); ?>

    </div>

    <div class="judul">
        <h3>Surat Keterangan Penerimaan Siswa</h3>
        <p>Tahun Pelajaran <?php echo e(date('Y')); ?>/<?php echo e(date('Y') + 1); ?></p>
    </div>
    ...
    <div class="isi">
        ...
        <table class="tabel-data">
            <tr>
                <td>Nama</td>
                <td>: <b><?php echo e($attempt->student_name); ?></b></td>
            </tr>
            <tr>
                <td>NISN</td>
        ...
        <div class="status-box">
            <div class="status"><?php echo e($attempt->status); ?></div>
        </div>

        <p class="compact">Sebagai calon peserta didik baru MA NU Luthful Ulum tahun pelajaran
            <?php echo e(date('Y')); ?>/<?php echo e(date('Y') + 1); ?> dengan perolehan nilai seleksi sebagai berikut:</p>
        ...
        <div class="ttd">
            ...
            <div class="ttd-kanan">
                <p>Pasucen, <?php echo e(date('d F Y')); ?></p>
                <p>Kepala Sekolah,</p>

                <?php if(isset($signatureBase64) && !empty($signatureBase64)): ?>
                    <div style="height: 80px; margin: 10px 0;">
                        <img src="<?php echo e($signatureBase64); ?>" alt="Tanda Tangan Kepala Sekolah" style="height: 80px;">
                    </div>
                <?php else: ?>
...
<?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/admin/pengumuman/surat_kelulusan.blade.php ENDPATH**/ ?>