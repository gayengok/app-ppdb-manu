                    ...
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-header bg-gradient-primary text-white p-4 rounded-top">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="card-title mb-0 font-weight-bold">Edit Data Siswa Kelas 12</h4>
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('kelas-12.update', $kelasDuaBelas->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="nisn" name="nisn" value="<?php echo e($kelasDuaBelas->nisn); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="full_name" name="full_name" value="<?php echo e($kelasDuaBelas->full_name); ?>"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Laki-laki"
                                                        <?php echo e($kelasDuaBelas->gender == 'Laki-laki' ? 'selected' : ''); ?>>
                                                        Laki-laki
                                                    </option>
                                                    <option value="Perempuan"
                                                        <?php echo e($kelasDuaBelas->gender == 'Perempuan' ? 'selected' : ''); ?>>
                                                        Perempuan
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Aktif"
                                                        <?php echo e($kelasDuaBelas->status == 'Aktif' ? 'selected' : ''); ?>>
                                                        Aktif
                                                    </option>
                                                    <option value="Tidak Aktif"
                                                        <?php echo e($kelasDuaBelas->status == 'Tidak Aktif' ? 'selected' : ''); ?>>
                                                        Tidak Aktif
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-left-0 bg-light" id="address" name="address" required rows="3"
                                                    placeholder="Masukkan alamat lengkap"><?php echo e($kelasDuaBelas->address); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="<?php echo e(route('kelas-12.index')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('backend.dashboard.dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/data-siswa/kelas-12/edit-data-kelas-12.blade.php ENDPATH**/ ?>