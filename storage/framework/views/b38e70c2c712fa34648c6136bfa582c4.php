...
<body>
    <div class="register-container">
        ...
        <div class="right-side">
            ...
            <form id="loginForm" method="POST" action="<?php echo e(route('login.process')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/login/login.blade.php ENDPATH**/ ?>