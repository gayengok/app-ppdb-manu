                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title fw-bold mb-0">Data Siswa Kelas 12</h4>
                        </div>
                        <a href="<?php echo e(route('kelas-12.create')); ?>" class="btn btn-light d-flex align-items-center">
                                ...
                                <div class="card bg-info bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0"><?php echo e($kelasDuaBelas->count()); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-success bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0"><?php echo e($kelasDuaBelas->where('status', 'Aktif')->count()); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-danger bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0"><?php echo e($kelasDuaBelas->where('status', '!=', 'Aktif')->count()); ?>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle border-top" id="studentTable">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $kelasDuaBelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelasDuabelasData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="student-row">
                                            <td class="text-center fw-bold"><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($kelasDuabelasData->nisn); ?></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-circle bg-primary text-white me-2">
                                                        <?php echo e(substr($kelasDuabelasData->full_name, 0, 1)); ?>

                                                    </div>
                                                    <div><?php echo e($kelasDuabelasData->full_name); ?></div>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if($kelasDuabelasData->gender === 'laki-laki'): ?>
                                                    <i class="fas fa-mars text-primary me-1"></i>
                                                <?php else: ?>
                                                    <i class="fas fa-venus text-danger me-1"></i>
                                                <?php endif; ?>
                                                <?php echo e(ucfirst($kelasDuabelasData->gender)); ?>

                                            </td>
                                            <td>
                                                <div class="text-truncate" style="max-width: 200px;"
                                                    title="<?php echo e($kelasDuabelasData->address); ?>">
                                                    <i class="fas fa-map-marker-alt text-muted me-1"></i>
                                                    <?php echo e($kelasDuabelasData->address); ?>

                                                </div>
                                            </td>
                                            <td>
                                                <?php if($kelasDuabelasData->status === 'Aktif'): ?>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="<?php echo e(route('kelas-12.edit', $kelasDuabelasData->id)); ?>"
                                                        class="btn btn-sm btn-warning rounded-circle"
                                                        data-bs-toggle="tooltip" title="Edit Siswa">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="<?php echo e(route('kelas-12.destroy', $kelasDuabelasData->id)); ?>"
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-center py-4">
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <a href="<?php echo e(route('kelas-12.create')); ?>"
                    ...
                    <div class="card-footer bg-light py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">Menampilkan <?php echo e($kelasDuaBelas->count()); ?> dari
                                    <?php echo e($kelasDuaBelas->count()); ?> siswa</small>
                            </div>
                            <div>
...
<?php echo $__env->make('backend.dashboard.dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/data-siswa/kelas-12/data-kelas-12.blade.php ENDPATH**/ ?>