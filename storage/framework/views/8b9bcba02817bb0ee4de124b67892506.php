                    ...
                    <div class="card-body p-0">
                        <div class="p-5"
                            ...
                            <div class="text-center mt-5">
                                <form action="<?php echo e(route('quiz.index')); ?>" method="GET">
                                    <button type="submit"
                                        class="btn btn-lg btn-success rounded-pill px-5 py-3 shadow-lg fw-bold position-relative overflow-hidden start-btn"
                                        style="min-width: 280px;"
                                        <?php if(!$status): ?> disabled style="pointer-events: none; opacity: 0.5;" <?php endif; ?>>
...
<?php echo $__env->make('backend.admin.app.app_siswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/admin/pendaftaran/test_ppdb/petunjuk.blade.php ENDPATH**/ ?>