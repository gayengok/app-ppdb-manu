        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="gallery-item <?php echo e($photo->category ?? 'event'); ?>">
                        <div class="gallery-card">
                            <div class="gallery-image-container">
                                <img src="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" alt="<?php echo e($photo->title ?? 'Photo'); ?>"
                                    class="gallery-img" data-title="<?php echo e($photo->title ?? 'Photo'); ?>"
                                    data-date="<?php echo e($photo->created_at->format('d M Y')); ?>"
                                    data-desc="<?php echo e($photo->description ?? ''); ?>">
                                <div class="gallery-overlay">
                                    <div class="overlay-content">
                                        <h3 class="photo-title"><?php echo e($photo->title ?? 'Photo'); ?></h3>
                                        <div class="photo-meta">
                                            ...
                                            <span class="photo-category">
                                                <i class="fas fa-tag"></i> <?php echo e($photo->category ?? 'Event'); ?>

                                            </span>
                                        </div>
                                        <button class="view-btn" data-img="<?php echo e(asset('storage/' . $photo->photo_path)); ?>">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item <?php echo e($photos->onFirstPage() ? 'disabled' : ''); ?>">
                                    <a class="page-link" href="<?php echo e($photos->previousPageUrl()); ?>">
                                ...
                                <li class="page-item <?php echo e(!$photos->hasMorePages() ? 'disabled' : ''); ?>">
                                    <a class="page-link" href="<?php echo e($photos->nextPageUrl()); ?>">
