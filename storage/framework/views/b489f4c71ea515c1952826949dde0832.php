                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('kelas-10.update', $kelasSepuluh->id)); ?>" method="POST">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="nisn" name="nisn" value="<?php echo e($kelasSepuluh->nisn); ?>" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="full_name" name="full_name" value="<?php echo e($kelasSepuluh->full_name); ?>"
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Aktif"
                                                        <?php echo e($kelasSepuluh->status == 'Aktif' ? 'selected' : ''); ?>>
                                                        Aktif
                                                    </option>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-left-0 bg-light" id="address" name="address" required rows="3"
                                                    placeholder="Masukkan alamat lengkap"><?php echo e($kelasSepuluh->address); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="<?php echo e(route('kelas-10.index')); ?>" class="btn btn-outline-secondary btn-lg">
