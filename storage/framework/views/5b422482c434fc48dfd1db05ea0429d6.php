                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-bottom">
                                                ...
                                                <td class="py-3 font-weight-bold"><?php echo e($student->nama_lengkap); ?></td>
                                                <td class="py-3">
                                                    <?php if($student->jenis_kelamin == 'Laki-laki'): ?>
                                                        <span class="text-primary"><i class="fas fa-mars mr-1"></i>
                                                            <?php echo e($student->jenis_kelamin); ?></span>
                                                    <?php else: ?>
                                                ...
                                                <td class="py-3">
                                                    <a href="mailto:<?php echo e($student->email); ?>" class="text-primary">
                                                        <i class="fas fa-envelope mr-1"></i> <?php echo e($student->email); ?>

                                                    </a>
                                                </td>
                                                <td class="text-center py-3">
                                                    <?php if($student->status == 'Terima'): ?>
                                                        <div class="badge badge-pill bg-success text-white px-3 py-2">
                                                            <i class="fas fa-check-circle mr-1"></i> TERIMA
                                                        </div>
                                                    <?php elseif($student->status == 'Tidak Terima'): ?>
...
<?php echo $__env->make('backend.admin.app.app_siswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT WEB SKRIPSI\PPDB_MA_NU_LU\resources\views/backend/admin/verifikasi/verifikasi.blade.php ENDPATH**/ ?>