            ...
            <div class="row">
                <div class="col-lg-8 mx-auto content-container">
                    ...
                    <p class="text-center text-muted mb-4" style="position: relative; top: -10px; font-size: 1rem;">
                        {{ \Carbon\Carbon::parse($artikel->published_date)->format('d F Y') }} | Oleh:
                        {{ $artikel->author }}</p>
                    ...
                    <div class="text-center article-image mb-4">
                        <img src="{{ asset('storage/' . $artikel->image) }}" alt="Gambar Berita" class="img-fluid"
                    ...
                    <div class="artikel-body" style="font-size: 1.125rem; line-height: 1.8; color: #333;">
                        <p><span style="font-size: 14.98px;">{!! $artikel->content !!}</span></p>
                    </div>
                </div>
                            ...
                            <div class="col-12 mb-4">
                                <div class="card article-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('article.show', $related->id) }}" class="btn btn-sm btn-success">
                                            Baca Selengkapnya
                                        </a>
                                    </div>
                                </div>
