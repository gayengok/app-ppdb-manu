                    ...
                    <div class="col-md-4">
                        <div class="card news-card h-100 border-0 shadow-sm hover-effect">
                            <div class="card-img-wrapper">
                                <img src="{{ asset('storage/' . $artikel->image) }}" class="card-img-top"
                                    alt="{{ $artikel->title }}">
                                <div class="card-date-badge">
                                    {{ \Carbon\Carbon::parse($artikel->published_date)->format('d') }}
                                    <span
                                        class="d-block small">{{ \Carbon\Carbon::parse($artikel->published_date)->format('M') }}</span>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                ...
                                <h3 class="card-title fw-bold">
                                    <a href="{{ route('article.show', $artikel->id) }}"
                                        class="stretched-link text-decoration-none text-dark">{{ $artikel->title }}</a>
                                </h3>
                                <p class="card-text text-muted">{{ $artikel->short_description }}</p>
                            </div>
                            <div
