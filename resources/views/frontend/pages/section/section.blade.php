        ...
        <div class="row gy-3">
            <div class="col-6 text-center">
                <div class="count-box premium-card">
                    ...
                    <div>
                        <span data-purecounter-start="0" data-purecounter-end="{{ $newStudentsCount }}"
            ...
            <div class="col-6 text-center">
                <div class="count-box premium-card">
                    ...
                    <div>
                        <span id="totalSiswa" data-purecounter-start="0" data-purecounter-end="{{ $totalSiswa }}"
                            data-purecounter-duration="1" class="purecounter premium-counter"></span>
            ...
            @foreach ($artikels as $index => $artikel)
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <img src="{{ asset('storage/' . $artikel->image) }}" class="card-img-top img-fluid"
                ...
                <div class="android-mockup">
                    @forelse ($uploadpendaftarans as $index => $item)
                        <div class="android-screen">
                            <img src="{{ asset('storage/' . $item->image_path) }}" class="android-image"
        ...
        {{-- <div class="row">
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="box text-center">
                        <img src="{{ asset('frontend/assets/img/unggul-1.png') }}" class="img-fluid"
                ...
                <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                    <div class="box text-center">
                        <img src="{{ asset('frontend/assets/img/unggul-2.png') }}" class="img-fluid"
                ...
                <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                    <div class="box text-center">
                        <img src="{{ asset('frontend/assets/img/unggul-3.png') }}" class="img-fluid"
