                    ...
                    <div class="card shadow-lg border-0 rounded-lg">
                        <div class="card-header bg-gradient-primary text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('guru.create') }}" class="btn btn-light btn-rounded">
                        ...
                        <div class="card-body p-4">
                                    ...
                                    <tbody>
                                        @forelse ($gurus as $index => $guru)
                                            <tr class="border-bottom">
                                                <td class="align-middle">{{ $gurus->firstItem() + $index }}</td>
                                                <td class="align-middle font-weight-bold">{{ $guru->nama }}</td>
                                                <td class="align-middle">{{ $guru->alamat }}</td>
                                                <td class="align-middle">
                                                    <a href="mailto:{{ $guru->email }}" class="text-primary">
                                                        {{ $guru->email }}
                                                    </a>
                                                </td>
                                                <td class="align-middle">
                                            ...
                                            <tr>
                                                <td colspan="6" class="text-center py-5">
                                                    <div class="empty-state">
                                                        <img src="{{ asset('images/empty-data.svg') }}" alt="No Data"
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <div class="text-muted">
                                    Menampilkan {{ $gurus->firstItem() }} sampai {{ $gurus->lastItem() }} dari
                                    {{ $gurus->total() }} total data
                                </div>
                                <div>
