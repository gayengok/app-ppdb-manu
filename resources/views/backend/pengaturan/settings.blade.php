                            ...
                            <div class="mb-4">
                                ...
                                <div class="p-4 border rounded-lg bg-white position-relative transition-all shadow-hover"
                                        ...
                                        <div class="col-md-4 text-end">
                                            <div
                                                ...
                                                <label class="form-check-label me-3 small text-muted" for="quiz_status">
                                                    {{ $setting->quiz_status ? 'Active' : 'Inactive' }}
                                                </label>
                                                <input class="form-check-input shadow-sm" type="checkbox" id="quiz_status"
                                                    name="quiz_status" {{ $setting->quiz_status ? 'checked' : '' }}
                                                    style="width: 3.8em; height: 2em; cursor: pointer; background-color: {{ $setting->quiz_status ? '#3a7bd5' : '#ced4da' }}; border: none;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-absolute top-0 end-0 mt-2 me-2">
                                        <span
                                            class="badge rounded-pill bg-{{ $setting->quiz_status ? 'success' : 'secondary' }} px-2 py-1">
                                            <i
                                                class="fas fa-{{ $setting->quiz_status ? 'check-circle' : 'times-circle' }} me-1"></i>
                                            {{ $setting->quiz_status ? 'Enabled' : 'Disabled' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
