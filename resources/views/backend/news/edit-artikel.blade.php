                        ...
                        <div class="card-header bg-gradient-primary text-white">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small>Edit artikel "{{ $artikel->title }}"</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('articles.update', $artikel->id) }}" method="POST"
                                        ...
                                        <div class="card shadow-sm mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="content" name="content" class="form-control summernote" rows="12" required>{{ old('content', $artikel->content) }}</textarea>
                                ...
                                <div class="form-group mt-4 d-flex justify-content-between">
                                    <a href="{{ route('news.berita') }}" class="btn btn-outline-secondary">
