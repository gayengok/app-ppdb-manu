...
<body>
    <div class="register-container">
        ...
        <div class="right-side">
            ...
            <form id="loginForm" method="POST" action="{{ route('login_siswa.login') }}">
                @csrf
                ...
                <div class="form-check">
                    ...
                    <label for="termsCheckbox">Saya menyetujui</label>
                </div>
                <button type="submit" class="register-button">Masuk Sekarang</button>
                <p class="login-link"><a href="{{ route('register_siswa.index') }}">Daftar
                        Sekarang</a></p>

                {{-- <div class="remember-forgot">
                    <div class="remember-me">
                        <input type="checkbox" id="rememberMe" onchange="toggleLoginButton()">
                        <label for="rememberMe">Ingat saya</label>
                    </div>
                    <a href="#" class="forgot-password">Lupa password?</a>
                </div>
                <button type="submit" id="loginButton" class="login-button" disabled>Masuk</button>
                <div class="register-link">
                    <a href="{{ route('register_siswa.index') }}" class="register-button">Daftar Sekarang</a>
                </div> --}}
