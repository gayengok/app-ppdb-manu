                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('kelas-11.update', $kelasSebelas->id) }}" method="POST">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="nisn" name="nisn" value="{{ $kelasSebelas->nisn }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="full_name" name="full_name" value="{{ $kelasSebelas->full_name }}"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Laki-laki"
                                                        {{ $kelasSebelas->gender == 'Laki-laki' ? 'selected' : '' }}>
                                                        Laki-laki
                                                    </option>
                                                    <option value="Perempuan"
                                                        {{ $kelasSebelas->gender == 'Perempuan' ? 'selected' : '' }}>
                                                        Perempuan
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Aktif"
                                                        {{ $kelasSebelas->status == 'Aktif' ? 'selected' : '' }}>
                                                        Aktif
                                                    </option>
                                                    <option value="Tidak Aktif"
                                                        {{ $kelasSebelas->status == 'Tidak Aktif' ? 'selected' : '' }}>
                                                        Tidak Aktif
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-left-0 bg-light" id="address" name="address" required rows="3"
                                                    placeholder="Masukkan alamat lengkap">{{ $kelasSebelas->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('kelas-11.index') }}" class="btn btn-outline-secondary btn-lg">
