                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('kelas-12.create') }}" class="btn btn-primary mb-3">
                                    ...
                                    <tbody>
                                        @forelse ($kelasDuaBelas as $kelasDuabelasData)
                                            <tr>
                                                ...
                                                <td>{{ $kelasDuabelasData->full_name }}</td>
                                                <td>{{ ucfirst($kelasDuabelasData->gender) }}</td>
                                                <td>{{ $kelasDuabelasData->address }}</td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                                                        ...
                                                        <!-- Form Hapus -->
                                                        <form
                                                            action="{{ route('kelas-12.destroy', $kelasDuabelasData->id) }}"
