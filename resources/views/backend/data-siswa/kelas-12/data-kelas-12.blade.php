            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-lg">
                    ...
                    <div
                        ...
                        <a href="{{ route('kelas-12.create') }}" class="btn btn-light d-flex align-items-center">
                                ...
                                <div class="card bg-info bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasDuaBelas->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-success bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasDuaBelas->where('status', 'Aktif')->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-danger bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasDuaBelas->where('status', '!=', 'Aktif')->count() }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle border-top" id="studentTable">
                                ...
                                <tbody>
                                    @forelse ($kelasDuaBelas as $kelasDuabelasData)
                                        <tr class="student-row">
                                            <td class="text-center fw-bold">{{ $loop->iteration }}</td>
                                            <td>{{ $kelasDuabelasData->nisn }}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-circle bg-primary text-white me-2">
                                                        {{ substr($kelasDuabelasData->full_name, 0, 1) }}
                                                    </div>
                                                    <div>{{ $kelasDuabelasData->full_name }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                @if ($kelasDuabelasData->gender === 'laki-laki')
                                                    <i class="fas fa-mars text-primary me-1"></i>
                                                @else
                                                    <i class="fas fa-venus text-danger me-1"></i>
                                                @endif
                                                {{ ucfirst($kelasDuabelasData->gender) }}
                                            </td>
                                            <td>
                                                <div class="text-truncate" style="max-width: 200px;"
                                                    title="{{ $kelasDuabelasData->address }}">
                                                    <i class="fas fa-map-marker-alt text-muted me-1"></i>
                                                    {{ $kelasDuabelasData->address }}
                                                </div>
                                            </td>
                                            <td>
                                                @if ($kelasDuabelasData->status === 'Aktif')
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('kelas-12.edit', $kelasDuabelasData->id) }}"
                                                        class="btn btn-sm btn-warning rounded-circle"
                                                        data-bs-toggle="tooltip" title="Edit Siswa">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('kelas-12.destroy', $kelasDuabelasData->id) }}"
                    ...
                    <div class="card-footer bg-light py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">Menampilkan {{ $kelasDuaBelas->count() }} dari
                                    {{ $kelasDuaBelas->count() }} siswa</small>
                            </div>
                            <div>
