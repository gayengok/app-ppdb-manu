            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-lg">
                    <div
                        ...
                        <a href="{{ route('kelas-10.create') }}" class="btn btn-light d-flex align-items-center">
                                ...
                                <div class="card bg-info bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasSepuluhs->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-success bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasSepuluhs->where('status', 'Aktif')->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-danger bg-opacity-10 border-0">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="mb-0">{{ $kelasSepuluhs->where('status', '!=', 'Aktif')->count() }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle border-top" id="studentTable">
                                ...
                                <tbody>
                                    @forelse ($kelasSepuluhs as $kelasSepuluhData)
                                        <tr class="student-row">
                                            <td class="text-center fw-bold">{{ $loop->iteration }}</td>
                                            <td>{{ $kelasSepuluhData->nisn }}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-circle bg-primary text-white me-2">
                                                        {{ substr($kelasSepuluhData->full_name, 0, 1) }}
                                                    </div>
                                                    <div>{{ $kelasSepuluhData->full_name }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                @if ($kelasSepuluhData->gender === 'laki-laki')
                                                    <i class="fas fa-mars text-primary me-1"></i>
                                                @else
                                                    <i class="fas fa-venus text-danger me-1"></i>
                                                @endif
                                                {{ ucfirst($kelasSepuluhData->gender) }}
                                            </td>
                                            <td>
                                                <div class="text-truncate" style="max-width: 200px;"
                                                    title="{{ $kelasSepuluhData->address }}">
                                                    <i class="fas fa-map-marker-alt text-muted me-1"></i>
                                                    {{ $kelasSepuluhData->address }}
                                                </div>
                                            </td>
                                            <td>
                                                @if ($kelasSepuluhData->status === 'Aktif')
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('kelas-10.edit', $kelasSepuluhData->id) }}"
                                                        class="btn btn-sm btn-warning rounded-circle"
                                                        data-bs-toggle="tooltip" title="Edit Siswa">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('kelas-10.destroy', $kelasSepuluhData->id) }}"
                    ...
                    <div class="card-footer bg-light py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">Menampilkan {{ $kelasSepuluhs->count() }} dari
                                    {{ $kelasSepuluhs->count() }} siswa</small>
                            </div>
                            <div>
