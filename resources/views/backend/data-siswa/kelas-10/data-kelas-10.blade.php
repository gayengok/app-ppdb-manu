                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('kelas-10.create') }}" class="btn btn-primary mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered"
                                    ...
                                    <tbody>
                                        @forelse ($kelasSepuluhs as $kelasSepuluh)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $kelasSepuluh->nisn }}</td>
                                                <td>{{ $kelasSepuluh->full_name }}</td>
                                                <td>{{ ucfirst($kelasSepuluh->gender) }}</td>
                                                <td>{{ $kelasSepuluh->address }}</td>
                                                <td>
                                                    @if ($kelasSepuluh->status === 'Aktif')
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                                                        <!-- Tombol Edit -->
                                                        <a href="{{ route('kelas-10.edit', $kelasSepuluh->id) }}"
                                                            class="btn btn-warning d-flex align-items-center">
                                                            <i class="fas fa-edit"></i>
                                                        </a>

                                                        <!-- Form Hapus -->
                                                        <form action="{{ route('kelas-10.destroy', $kelasSepuluh->id) }}"
