                    ...
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-header bg-gradient-primary text-white p-4 rounded-top">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="card-title mb-0 font-weight-bold">Edit Data Siswa Kelas 10</h4>
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('kelas-10.update', $kelasSepuluh->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="nisn" name="nisn" value="{{ $kelasSepuluh->nisn }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-left-0 bg-light"
                                                    id="full_name" name="full_name" value="{{ $kelasSepuluh->full_name }}"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Laki-laki"
                                                        {{ $kelasSepuluh->gender == 'Laki-laki' ? 'selected' : '' }}>
                                                        Laki-laki
                                                    </option>
                                                    <option value="Perempuan"
                                                        {{ $kelasSepuluh->gender == 'Perempuan' ? 'selected' : '' }}>
                                                        Perempuan
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-left-0 bg-light custom-select"
                                                    ...
                                                    <option value="Aktif"
                                                        {{ $kelasSepuluh->status == 'Aktif' ? 'selected' : '' }}>
                                                        Aktif
                                                    </option>
                                                    <option value="Tidak Aktif"
                                                        {{ $kelasSepuluh->status == 'Tidak Aktif' ? 'selected' : '' }}>
                                                        Tidak Aktif
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-left-0 bg-light" id="address" name="address" required rows="3"
                                                    placeholder="Masukkan alamat lengkap">{{ $kelasSepuluh->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('kelas-10.index') }}" class="btn btn-outline-secondary btn-lg">
