                ...
                <div class="col-md-12">
                    <div class="card shadow-lg">
                        <div
                            ...
                            <a href="{{ route('videos.create') }}" class="btn btn-light btn-sm px-3 font-weight-bold">
                        ...
                        <div class="card-body p-0">
                                    ...
                                    <tbody>
                                        @foreach ($videos as $index => $video)
                                            <tr class="border-bottom">
                                                ...
                                                <td class="py-3 px-4 font-weight-bold">{{ $video->title }}</td>
                                                <td class="py-3 px-4">
                                                    @php
                                                        $videoId = null;
                                                        if (
                                                ...
                                                <td class="py-3 px-4 text-muted">{{ $video->created_at->format('d M Y') }}
                                                </td>
                            ...
                            @if ($videos->isEmpty())
                                <div class="text-center py-5">
                                    <img src="{{ asset('assets/img/empty-state.svg') }}" alt="No Data" width="120"
                                        class="mb-3">
