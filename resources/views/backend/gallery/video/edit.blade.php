                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('videos.update', $video->id) }}" method="POST">
                                ...
                                <div class="mt-4 mb-3" id="video-preview-container">
                                    ...
                                    <div
                                        class="video-preview-placeholder text-center py-5 bg-light rounded {{ $videoId ? 'd-none' : '' }}">
                                    ...
                                    <div class="video-preview-frame {{ $videoId ? '' : 'd-none' }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="font-weight-bold">
                                                        {{ $video->updated_at->format('d M Y, H:i') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
